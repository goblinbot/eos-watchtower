    ...
    public static init(): void {
        if (!this.ingameDate) {
            this.ingameDate = this.convertToIcDateObject({
                ocEventStart: new Date(2019, 2, 29, 12), // at 12 o clock for timezone shenanigans.
                icEventStart: new Date(2019, 3, 24, 12), // It's important that the current IC year is also the OC year.
                icStartYear: 240,
                icStartDayOfWeek: 5,
                icYearAfter: 'NT'
            });
